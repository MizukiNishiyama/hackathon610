    ...
    return (
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Button color="inherit"  onClick={signInWithGoogle} sx={{ margin:"3px", bgcolor:"blue"}}>Login</Button>
          <Button color="inherit"  onClick={signOutWithGoogle} sx={{ margin:"3px", bgcolor:"blue"}}>Logout</Button>
